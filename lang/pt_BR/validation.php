...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Validation Language Lines - Português Brasil
    |--------------------------------------------------------------------------
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'O valor informado para :attribute já apareceu em vazamentos de dados. Por favor, escolha outro.',
    ],
    ...
    'uploaded' => 'Falha ao fazer upload do arquivo :attribute. Verifique o tamanho máximo permitido.',
    ...
    */
    ...
    'attributes' => [
        ...
        'price_adult' => 'preço adulto',
        'price_child' => 'preço criança',
        'family_index' => 'índice família',
        'shade_level' => 'nível de sombra',
    ],
